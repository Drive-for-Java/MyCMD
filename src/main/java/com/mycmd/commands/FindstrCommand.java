...
public class FindstrCommand implements Command {
    ...
    private void searchInFile(java.io.File file, String searchString, Pattern pattern,
                              boolean caseInsensitive, boolean showLineNumbers, boolean useRegex) throws IOException {
